 ...
 */
public class GithubFragment extends Fragment implements MainMethods {
    ...
    public void init() {
        context = getContext();
        title = view.findViewById(R.id.title_github_frag);
        subtitle = view.findViewById(R.id.sub_github_frag);
        mainText = view.findViewById(R.id.main_text_github_frag);
