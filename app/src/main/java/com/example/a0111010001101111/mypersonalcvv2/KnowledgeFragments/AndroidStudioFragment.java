 ...
 */
public class AndroidStudioFragment extends Fragment implements MainMethods {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_android_studio,container,false);
    ...
    public void init(){
        context = getContext();
        title = view.findViewById(R.id.title_android_frag);
        subtitle = view.findViewById(R.id.sub_android_frag);
        mainText = view.findViewById(R.id.main_text_android_frag);
