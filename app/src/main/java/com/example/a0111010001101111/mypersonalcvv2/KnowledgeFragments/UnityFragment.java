 ...
 */
public class UnityFragment extends Fragment implements MainMethods {
    ...
    public void init() {
        context = getContext();
        title = view.findViewById(R.id.title_unity_frag);
        subtitle = view.findViewById(R.id.sub_unity_frag);
        mainText = view.findViewById(R.id.main_text_unity_frag);
